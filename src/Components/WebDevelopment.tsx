    ...
    <>
      <div>
        <div className='flex flex-col gap-8 justify-center items-center min-h-[70vh] bg-gradient-to-r from-blue-300 via-blue-200 to-gray-100 px-4 md:px-8'>
          ...
          <button className="border border-black px-4 py-2 rounded-md hover:bg-gradient-to-r from-blue-300 via-blue-200 to-gray-100 hover:scale-125 transition-transform duration-300 hover:border-none">
            <p>Let`s Start</p>
          </button>
        </div>
